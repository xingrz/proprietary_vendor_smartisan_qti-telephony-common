...
.field private static final FEATURE_INVALID:I = 0xff

.field private static final FEATURE_OFF:I = 0x0

.field private static final FEATURE_ON:I = 0x1
...
.field private static final NVID_0:I = 0x0

.field private static final NVID_MAX:I = 0xea60
...
.field private static final SUB0:I = 0x0

.field private static final SUB1:I = 0x1
...
.method static constructor <clinit>()V
    ...
    :goto_0
    sput-boolean v0, Lcom/qualcomm/qcrilhook/QcRilHook;->DBG:Z
...
.method public qcRilDeactivateConfigBySub(I)Z
    .locals 7
    ...
    const-string/jumbo v6, "QCRIL_EVT_HOOK_DEACT_CONFIG_BY_SUB failed w/ "
...
.method public qcRilEfsDelete(I[BI)Z
    .locals 9
    ...
    const-string/jumbo v7, "qcRilEfsDelete start, path = "
    ...
    const-string/jumbo v7, ", path_len = "
    ...
    const-string/jumbo v7, ", hookFlag = "
    ...
    const-string/jumbo v6, "path_len invalid"
    ...
    invoke-direct {p0, v2, v8, v5}, Lcom/qualcomm/qcrilhook/QcRilHook;->addQcRilHookHeader(Ljava/nio/ByteBuffer;II)V

    invoke-virtual {v2, p1}, Ljava/nio/ByteBuffer;->putInt(I)Ljava/nio/ByteBuffer;

    invoke-virtual {v2, p3}, Ljava/nio/ByteBuffer;->putInt(I)Ljava/nio/ByteBuffer;

    invoke-virtual {p0, v2, p2, p3}, Lcom/qualcomm/qcrilhook/QcRilHook;->qcRilPutNvEfsValue(Ljava/nio/ByteBuffer;[BI)Z
    ...
    const-string/jumbo v6, "qcRilPutNvEfsValue failed, path"
    ...
    :cond_2
    invoke-direct {p0, v8, v1}, Lcom/qualcomm/qcrilhook/QcRilHook;->sendRilOemHookMsg(I[B)Landroid/os/AsyncResult;
    ...
    const-string/jumbo v7, "QCRIL_EVT_HOOK_MODEM_COMM_OPT failed w/ "
...
.method public qcRilEfsRead(I[BI)[B
    .locals 9
    ...
    const-string/jumbo v7, "qcRilEfsRead start, path = "
    ...
    const-string/jumbo v6, "qcRilPutNvEfsValue failed"
    ...
    const-string/jumbo v6, "QCRIL_EVT_HOOK_MODEM_COMM_OPT failed w/ null result"
...
.method public qcRilEfsWrite(I[BI[BI)Z
    .locals 9
    ...
    const-string/jumbo v7, "qcRilEfsWrite start, path = "
    ...
    const-string/jumbo v7, ", value_len = "
    ...
    const-string/jumbo v6, "value_len invalid"
    ...
    invoke-virtual {p0, v2, p4, p5}, Lcom/qualcomm/qcrilhook/QcRilHook;->qcRilPutNvEfsValue(Ljava/nio/ByteBuffer;[BI)Z
    ...
    const-string/jumbo v6, "qcRilPutNvEfsValue failed, value"
...
.method public qcRilGetDefault(I)Ljava/lang/String;
    .locals 9
    ...
    invoke-direct {p0, v1, v8, v6}, Lcom/qualcomm/qcrilhook/QcRilHook;->addQcRilHookHeader(Ljava/nio/ByteBuffer;II)V
    ...
    const-string/jumbo v7, "QCRIL_EVT_HOOK_GET_DEFAULT failed w/ "
    ...
    const-string/jumbo v6, "QCRIL_EVT_HOOK_GET_DEFAULT failed w/ null result"
    ...
    const-string/jumbo v7, "QCRIL_EVT_HOOK_GET_DEFAULT returned w/ "
    ...
    const-string/jumbo v7, "set with incorrect type: "
...
.method public qcRilGetFeature(I)I
    .locals 8
    ...
    invoke-direct {p0, v1, v7, v6}, Lcom/qualcomm/qcrilhook/QcRilHook;->addQcRilHookHeader(Ljava/nio/ByteBuffer;II)V
    ...
    const-string/jumbo v7, "QCRIL_EVT_HOOK_GET_FEATURE failed w/ "
    ...
    const-string/jumbo v7, "QCRIL_EVT_HOOK_GET_FEATURE returned w/ "
    ...
    const-string/jumbo v7, "set with incorrect subMask: "
...
.method public qcRilModemHookCom(I)Z
    .locals 9
    ...
    const-string/jumbo v7, "qcRilModemHookCom start, hookFlag = "
...
.method public qcRilNvRead(III)[B
    .locals 9
    ...
    const-string/jumbo v7, "qcRilNvRead start, sub = "
    ...
    const-string/jumbo v6, "invalid sub"
    ...
    const-string/jumbo v6, "invalid nvId"
...
.method public qcRilNvSync(I)Z
    ...
    const-string/jumbo v7, "qcRilNvSync start, hookFlag = "
...
.method public qcRilNvWrite(III[BI)Z
    .locals 9
    ...
    const-string/jumbo v7, "qcRilNvWrite start, sub = "
...
.method public qcRilPutNvEfsValue(Ljava/nio/ByteBuffer;[BI)Z
    .locals 4
    ...
    const-string/jumbo v3, "qcRilPutNvEfsValue, value is null"
    ...
    const-string/jumbo v3, "qcRilPutNvEfsValue, buf is null"
...
.method public qcRilSetFeature(II)Z
    .locals 7
    ...
    invoke-direct {p0, v1, v4, v3}, Lcom/qualcomm/qcrilhook/QcRilHook;->addQcRilHookHeader(Ljava/nio/ByteBuffer;II)V
    ...
    invoke-direct {p0, v4, v2}, Lcom/qualcomm/qcrilhook/QcRilHook;->sendRilOemHookMsg(I[B)Landroid/os/AsyncResult;
    ...
    const-string/jumbo v5, "QCRIL_EVT_HOOK_SET_FEATURE failed w/ "
    ...
    const-string/jumbo v4, "QCRIL_EVT_HOOK_SET_FEATURE returned ok"
    ...
    const-string/jumbo v5, "set with incorrect subMask: "
    ...
    const-string/jumbo v5, ", or incorrect opt_flag: "
...
.method public qcRilSwitchTest(II)Z
    .locals 9
    ...
    const-string/jumbo v7, "qcRilSwitchTest start, hookFlag = "
    ...
    const-string/jumbo v6, "optFlag invalid"
